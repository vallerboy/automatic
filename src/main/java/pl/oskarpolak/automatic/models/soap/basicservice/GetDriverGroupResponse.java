 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.fleetboard.com/data}DriverGroup" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class GetDriverGroupResponse {
    ...
    protected List<DriverGroup> driverGroup;
     ...
     * This is why there is not a <CODE>set</CODE> method for the driverGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDriverGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DriverGroup> getDriverGroup() {
        if (driverGroup == null) {
            driverGroup = new ArrayList<DriverGroup>();
        }

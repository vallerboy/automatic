 ...
 *       &lt;sequence&gt;
 *         &lt;element name="User" type="{http://www.fleetboard.com/data}TmSoapUserType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class GetUserResponseType {
    ...
    protected List<TmSoapUserType> user;
     ...
     * 
     */
    public List<TmSoapUserType> getUser() {
        if (user == null) {
            user = new ArrayList<TmSoapUserType>();
        }
        return this.user;
    }
